...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | Give&Take - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page Give&Take Dashboard Template",
  // other metadata
};
