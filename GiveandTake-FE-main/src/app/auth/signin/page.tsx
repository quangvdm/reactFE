...
const SignIn: React.FC = () => {
  ...
  const setToken = useLocalStorage<string | null>("token", null)[1];
  const setUser = useLocalStorage<unknown | null>("user", null)[1];
  ...
  const signInMutation = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      let tokenString: string = data.data.jwtToken;
      // const token: string = data.data.jwtToken;
      // console.log(token);
      setToken(tokenString);
      // localStorage.setItem("token", token);
      // isTokenExpired(token.substring(0, token.length - 1));
      router.push("/");
      // save user data to local storage
      // const response = await request.user.getByEmail(email);
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className={"2xl:px-20 "}>
                Chia Sẻ Là Sức Mạnh Nhận Lại Là Niềm Vui.
              </p>

              <span className="mt-15 inline-block">{SignInSVG}</span>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      type="password"
                      placeholder="8+ Characters with 1 Capital letter"
                      value={password}
