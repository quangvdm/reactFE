...
import { MenuGroup } from "@/types/models/menuItem";
    ...
    menuItems: [
      {
        ...
        children: [
          ...
          // {
          //   icon: <LiaMoneyBillWaveAltSolid className="size-[1.2em]" />,
          //   label: "Transactions",
          //   route: "/transactions",
          // },
          // {
          ...
          // },
          {
            icon: <TbReport className="size-[1.25em]" />,
            label: "Reports",
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`z-100 \ fixed  left-0 top-0 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0
